...
class StudentModel:
    ...
    def evaluate_models(self, X_test, y_test, teacher_model_name="AutoEncoder", plot_cm=True):
        ...
        for name, model in self.trained_models.items():
            ...
            # Generate confusion matrix and plot/save it
            if plot_cm:
    ...
    def save_results(self, dataset, semi_supervised=False):
        """ Save results for supervised and semi-supervised learning. """
        file_path = os.path.join(self.results_dir, f"{dataset}_semi_supervised_student_results.csv" if semi_supervised else f"{dataset}_student_model_results.csv")
